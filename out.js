...
//tasks for exmpla
var myTask = [{ name: 'task 1', done: false, "id": "1" }];

//header in app
var myTitle = 'My ToDo List';

var App = function App() {
  return _react2.default.createElement(_ToDoList2.default, { title: myTitle, myTasks: myTask });
};
...
module.exports = __webpack_require__.p + "788e5a9a33ace31e82d1e264377d0937.png";

/***/ }),
/* 24 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "be3fde04f923e5a0350e7905a8b068a4.png";
...
var _ToDoItem = __webpack_require__(28);

var _ToDoItem2 = _interopRequireDefault(_ToDoItem);

var _NewToDoForm = __webpack_require__(29);

var _NewToDoForm2 = _interopRequireDefault(_NewToDoForm);

var _DeleteBtn = __webpack_require__(30);

var _DeleteBtn2 = _interopRequireDefault(_DeleteBtn);

var _DownloadList = __webpack_require__(31);
...
var ToDoList = function (_Component) {
  ...
  function ToDoList(props) {
    ...
    _this.downloadAllTask = function () {
      var actuallyList = _this.state.tasks;
      fetch('http://localhost:3000/tasks').then(function (response) {
        return response.json();
      }).then(function (json) {
        json.map(function (el) {
          return actuallyList.push(el);
        });
        json.map(function (el) {
        ...
        return alert('Brak połączenia z bazą danych -> RestAPI');
      });
    };

    _this.deleteState = function () {
      _this.setState({
        tasks: []
      });
    ...
    _this.deleteItem = function (indexToDelete) {
      _this.setState(function (_ref) {
        var tasks = _ref.tasks;
        return {
          tasks: tasks.filter(function (element, index) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'nav',
          null,
          _react2.default.createElement(_DeleteBtn2.default, { fnD: this.deleteState }),
          _react2.default.createElement(_DownloadList2.default, { fnDownload: this.downloadAllTask, fnDelete: this.deleteState })
        )
      );
    }
  }]);
...
var ToDoItem = function (_Component) {
  ...
  function ToDoItem(props) {
    ...
    _this.deleteAfterSave = function (e) {
      if (typeof _this.props.deleteItem == 'function') {
    ...
    _this.saveTask = function () {
      var confirmQuestion = confirm('Are you sure want to save your task in local file ?');
  ...
  _createClass(ToDoItem, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { onClick: this.deleteAfterSave, className: 'deleteTask', title: 'Delete' })
      );
    }
  }]);
...
var NewToDoForm = function (_Component) {
    _inherits(NewToDoForm, _Component);

    function NewToDoForm(props) {
        _classCallCheck(this, NewToDoForm);

        var _this = _possibleConstructorReturn(this, (NewToDoForm.__proto__ || Object.getPrototypeOf(NewToDoForm)).call(this, props));

        _this.newAddToState = function (e) {
            if (typeof _this.props.fnI == 'function') {
                _this.props.fnI(e);
            }
        };

        _this.newAddElement = function () {
            if (typeof _this.props.fnC == 'function') {
                _this.props.fnC();
            }
        };

        _this.newEnterAddElement = function (e) {
            if (e.charCode == 13) {
                _this.newAddElement();
            }
        };
...
var DeleteBtn = function (_Component) {
    ...
    function DeleteBtn(props) {
        ...
        _this.deleteAllTask = function () {
            if (typeof _this.props.fnD == 'function') {
                var confirmQuestion = confirm('Are you sure want to delete list of all tasks ?');
                if (confirmQuestion == true) {
                    _this.props.fnD();
                }
            }
    ...
    _createClass(DeleteBtn, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'styleBtnDelete', title: 'Delete all tasks', onClick: this.deleteAllTask },
                'Delete list'
            );
        }
    }]);
...
var DownloadList = function (_Component) {
    ...
    function DownloadList(props) {
        ...
        var _this = _possibleConstructorReturn(this, (DownloadList.__proto__ || Object.getPrototypeOf(DownloadList)).call(this, props));

        _this.clickDownloadTasks = function () {
            if (typeof _this.props.fnDownload == 'function') {
                var confirmQuestion = confirm('Are you sure to download tasks from local file and add do list ?');
                if (confirmQuestion == true) {
                    _this.props.fnDownload();
                }
            }
        };
    ...
    _createClass(DownloadList, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'styleBtnDownload', title: 'Download all tasks', onClick: this.clickDownloadTasks },
                'Download tasks'
            );
        }
    }]);
